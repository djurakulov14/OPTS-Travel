export const cities = [
    ...
    },
    {
        ...
        {
            id: 5,
            title: "Madrasah of Abdullazizkhan",
    ...
    },
    {
        id:3,
        title: "Khiva",
        subTitle: "Capital of the Turkic world",
    ...
    },
    {
        ...
        link: "/cityPage/id=4",
        history: "The city is 80 km from Samarkand. Shakhrisabz is translated as “Green City” and is one of the most ancient cities of Uzbekistan. Shakhrisabz is known throughout the world as the birthplace of the great commander Amir Temur (Tamerlane). Under his leadership, the city became a real centre of science and art. ou can find many architectural attractions in the city. The historical centre of the city is included in the UNESCO World Heritage List. The Government of Uzbekistan is actively introducing the concept of “Shakhrisabz – the city of festivals”, which reveals the huge potential of the city as a centre of culture and tourism. So, on the initiative of the President of Uzbekistan Shavkat Mirziyoyev, in September 2018, the International Folk Art Festival was held in Shakhrisabz for the first time. The festival is going to be held in the city every two years."
    },
    {
        id:5,
        title: "Tashkent",
        subTitle: "Mogern megapolis",
